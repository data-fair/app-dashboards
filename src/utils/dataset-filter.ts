 ...
 *
 * Pattern: `${prefix}_d_${datasetId}_${field}_${op}`
 *
 ...
 */
export const datasetFilterKey = (datasetId: string, field: string, prefix = '', op: 'in' | 'gte' | 'lte' = 'in'): string => {
  return `${prefix}_d_${datasetId || ''}_${field}_${op}`
}
